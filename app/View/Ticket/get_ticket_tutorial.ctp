<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-8 ">
            <h4 class="text-primary"> Đặt vé xe trực tuyến du lịch tham quan </h4><hr/>
                ...
                <div class="form-row">
                    <div class="form-group col-md-8">
                        ...
                        <select name="roads" ref="roads" class="form-control" required="required" data-parsley-required-message="Thiếu thông tin tuyến đường" >
                            ...
                            <option price="<?php echo $road['Road']['price']; ?>" value="<?php echo $road['Road']['id']; ?>"><?php echo $road['Road']['title']; ?> - (<?php echo $road['Road']['start_time']; ?>) - <?php echo number_format($road['Road']['price']); ?> VNĐ </option>
                            <?php } ?>
                        </select>
                    </div>
